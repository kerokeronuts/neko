...
// ---- Firestore アクセス用ヘルパー ----
// cats プロフィール: meta/cats { list: [...] }
// カレンダー用インデックス: index/{catId} { data: { 'YYYY-MM-DD': {hasPhoto, meal, poop} } }
// 個別の記録: entries/{catId}_{date} { photo, meal, poop, memo }
